    ...
    <div class="bg-white rounded-md p-10 h-max mt-5 border border-gray-300 w-475"> {{--i have made a custom width 475--}}
        <form action="{{route('store')}}" method="post" class="grid">
            ...
            <div class="flex justify-center">
                ...
                <img src="images/logo.png" alt="" class="h-20"></a>
            </div>
            ...
            <input type="text" name="firstname" placeholder="Enter Your first name" class="border border-gray-300 rounded-md p-2">
            ...
            <input type="text" name="lastname" placeholder="Enter Your last name" class="border border-gray-300 rounded-md p-2">
